#Installation script for Ansys Speos application
# --------------------------------------------------------------
...
#These are the some prerequisites required for installing Speos Applcation on centos 8.1
...
#installing Speos application with silent mode in the specified INSTALL_DIR

echo " Instaling Speos Application has been started in $INSTALL_DIR"

./INSTALL -silent -install_dir $INSTALL_DIR -speoshpc -nohelp

echo "Ansys Speos application is successfully installed"
