#Installation script for Ansys cfx application
# --------------------------------------------------------------
...
#These are the some prerequisites required for installing CFX Applcation on centos 8.1
...
#installing cfx application with silent mode in the specified INSTALL_DIR

echo " Instaling cfx Application has been started in $INSTALL_DIR"

./INSTALL -silent -install_dir $INSTALL_DIR -cfx -nohelp

echo "Ansys cfx application is successfully installed"
