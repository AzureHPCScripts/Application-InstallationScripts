...
1. Create a sh file in your terminal using "vim ansys_lsdyna_install.sh" and copy the script to that file and save it.
    or 
   Copy the ansys_lsdyna_install.sh file given to your terminal.

2. Give the user/group/others permission to execute the sh file by using the command "chmod +x ansys_lsdyna_install.sh"
...
Example-->  ./ansys_lsdyna_install.sh "STRUCTURES_2022R2_LINX64.tgz" "/home" "/usr/ansys_inc"
