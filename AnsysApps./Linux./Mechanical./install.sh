#Installation script for Ansys mechanical application
# --------------------------------------------------------------
...
#These are the some prerequisites required for installing Mechanical Applcation on centos 8.1
...
#installing mechanical application with silent mode in the specified INSTALL_DIR

echo " Instaling Mechanical Application has been started in $INSTALL_DIR"

./INSTALL -silent -install_dir $INSTALL_DIR -mechapdl -nohelp

echo "Ansys Mechanical application is successfully installed"
