#Installation script for Ansys fluent application
# --------------------------------------------------------------
...
#These are the some prerequisites required for installing FLUENT Applcation on centos 8.1
...
#installing fluent application with silent mode in the specified INSTALL_DIR

echo " Installing fluent Application has been started in $INSTALL_DIR"

./INSTALL -silent -install_dir $INSTALL_DIR -fluent -nohelp

echo "Ansys fluent application is successfully installed"
