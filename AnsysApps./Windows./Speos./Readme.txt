...
--------------------------------------
Prerequisites:User should download the Package file. Under Optical Package file,download whichever is suitable to install from the Ansys customer portal.
