...
--------------------------------------
Prerequisites:User should download the Package file i.e Fluids package file or structures & fluids combined package file whichever is suitable to install from the Ansys customer portal.
