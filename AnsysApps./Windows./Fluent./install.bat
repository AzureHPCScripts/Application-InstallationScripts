#Installation script for Ansys Fluent
#------------------------------------------------------------------
...
set INSTALL_DIR="C:\Program Files\Ansys_fluent"
...
echo "Installing fluent Apllication"

.\setup.exe -silent -install_dir %INSTALL_DIR% -fluent

echo "fluent application installed successfully"
