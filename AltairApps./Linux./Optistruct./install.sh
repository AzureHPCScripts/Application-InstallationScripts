#Installation script for Altair Optistruct application
# --------------------------------------------------------------
...
#Installing the Altair Optistruct application by using the property response file in silent mode

echo "Optistruct application Installation has been started"

./$PACKAGE -i silent -f "$PACKAGE_DIR/$Property_Filename" -DACCEPT_EULA=YES

echo "Altair Optistruct apllication has been installed succeessfully"
