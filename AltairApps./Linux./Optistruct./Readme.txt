...
----------------------------
Prerequstes:i)User should download the Optistruct Package file whichever is suitable to install from the Altair customer portal.
           ii)copy the installer.properties file to the directory where the Optistruct executable package is downloaded.
