#Installation script for Altair nfx application
# --------------------------------------------------------------
...
#Installing the Altair nfx application by using the property response file in silent mode

echo "nfx application Installation has been started"

./$PACKAGE -i silent -f "$PACKAGE_DIR/$Property_Filename" -DACCEPT_EULA=YES

echo "Altair nfx apllication has been installed succeessfully"
