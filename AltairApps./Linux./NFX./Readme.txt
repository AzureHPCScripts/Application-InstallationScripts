...
----------------------------
Prerequstes:i)User should download the Nfx Package file whichever is suitable to install from the Altair customer portal.
           ii)copy the installer.properties file to the directory where the Nfx executable package is downloaded.
