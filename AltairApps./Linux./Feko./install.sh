#Installation script for Altair Feko application
# --------------------------------------------------------------
...
#Installing the Altair Feko application by using the property response file in silent mode

echo "Feko application Installation has been started"

./$PACKAGE -i silent -f "$PACKAGE_DIR/$Property_Filename" -DACCEPT_EULA=YES

echo "Altair Feko application has been installed succeessfully"
