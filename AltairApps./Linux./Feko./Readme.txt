...
----------------------------
Prerequstes:i)User should download the Feko Package file whichever is suitable to install from the Altair customer portal.
           ii)copy the installer.properties file to the directory where the Feko executable package is downloaded.
...
Example-->  ./install.sh "hwCFDSolvers2022.1_linux64.bin" "/home" "installer.properties"
