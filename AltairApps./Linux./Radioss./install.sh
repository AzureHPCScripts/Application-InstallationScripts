#Installation script for Altair Radioss application
# --------------------------------------------------------------
...
#Installing the Altair Radioss application by using the property response file in silent mode

echo "Radioss application Installation has been started"

./$PACKAGE -i silent -f "$PACKAGE_DIR/$Property_Filename" -DACCEPT_EULA=YES

echo "Altair Radioss apllication has been installed succeessfully"
