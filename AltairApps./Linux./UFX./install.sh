#Installation script for Altair Ufx application
# --------------------------------------------------------------
...
#Installing the Altair Ufx application by using the property response file in silent mode

echo "Ufx application Installation has been started"

./$PACKAGE -i silent -f "$PACKAGE_DIR/$Property_Filename" -DACCEPT_EULA=YES

echo "Altair Ufx apllication has been installed succeessfully"
