...
----------------------------
Prerequstes:i)User should download the Ufx Package file whichever is suitable to install from the Altair customer portal.
           ii)copy the installer.properties file to the directory where the Ufx executable package is downloaded.
